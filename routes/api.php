...
//            Route::post('addresses', 'AddressesController@store');
            ...
            Route::post('orders/payment/success', 'OrdersController@setPaymentSuccess');
        ...
        Route::middleware(['driver'])->prefix('driver')->namespace('Driver')->group(function () {
            ...
            Route::post('jobs/{id}/photos','\App\Http\Controllers\Api\Driver\JobsController@uploadPhotos');
